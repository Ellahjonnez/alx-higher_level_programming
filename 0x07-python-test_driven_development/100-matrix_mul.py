...
def matrix_mul(m_a, m_b):
    ...
    Args:
        m_a (list of lists of integers or floats): The first matrix.
        m_b (list of lists of integers or floats): The second matrix.
    Raises exception:
        ...
        TypeError: each row of m_a must be of the same size or
